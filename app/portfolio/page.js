...
export const metadata = {
  title: 'Portfolio | HomeStake Capital - Current & Future Acquisitions',
  description:
    'View HomeStake Capital&apos;s portfolio of home service business acquisitions. Track our growth in HVAC, plumbing, electrical, roofing, and related trades across North America.',
  openGraph: {
    title: 'HomeStake Capital Portfolio',
    description:
      'Track our home service business acquisitions and portfolio growth',
  },
  alternates: {
    canonical: 'https://website-build-ivory.vercel.app/portfolio'
  },
};
